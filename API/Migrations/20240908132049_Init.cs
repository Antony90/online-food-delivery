    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketItem", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LocationPrefLong = table.Column<double>(type: "float", nullable: false),
                    LocationPrefLat = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryDriver_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartnerUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodPrepInstructions = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponOrder", x => new { x.CouponsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_CouponOrder_Coupon_CouponsId",
                        column: x => x.CouponsId,
                        principalTable: "Coupon",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CouponOrder_Order_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiveLocationLat = table.Column<double>(type: "float", nullable: false),
                    LiveLocationLong = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Delivery_DeliveryDriver_DeliveryDriverId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2778310b-4f48-4c9b-9ac3-317a96bedddf", null, "DeliveryDriver", "DELIVERYDRIVER" },
                    { "27bb9445-dcd9-484a-b42a-f773fe3183cc", null, "User", "USER" },
                    { "f6374f28-1ce9-4a86-837e-c60aff9729a1", null, "Partner", "PARTNER" },
                    { "ff0f0a0e-3ebe-4856-a071-3a66c5f29521", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delivery_DeliveryDriverId",
                table: "Delivery",
